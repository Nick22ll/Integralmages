...
public class parallelTest {
    ...
    parallelTest(GreyImage image,int[] num_threads, int executions){
        this.image = image;
        this.num_threads = num_threads;
        this.executions = executions;
    }

    Vector<Double> run_display() {
        Vector<Double> mean_values = new Vector<>();
        for (int threads : num_threads) {
            ...
            mean_values.addElement(mean_exec_time);
